...
<hr style="width: 100%">
<form action="AddressPaymentOrder.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="right-div">
<h3>Pay online on this Paytm Number 9648950581 </h3>
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mobilenumber" value="<%=rs2.getString(3)%>" placeholder="Enter Mobile Number" maxlength="10" required>
